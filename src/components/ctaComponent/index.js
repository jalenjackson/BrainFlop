  ...
  sendEmail(isEnter, e) {
    ...
    if(!this.state.name) {
      ...
      if (this.validateEmail(this.state.email) && this.state.name) {
        $.ajax({
          type: 'POST',
          url: `http://localhost:8080/users/cta-user`,
          data: JSON.stringify({email: this.state.email, name: this.state.name}),
          contentType: 'application/json; charset=utf-8',
          dataType: 'json',
          success: (response) => {
            $('.error-msg').css({ color: 'green' });
            this.setState({errorMessage: 'Thank you! We will notify you if you are a winner!', name: '', email: ''}, () => {
              setTimeout(() => {
        ...
        this.setState({errorMessage: 'Sorry please enter a valid email address'})
      }
    }
  }
                          ...
                          <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <defs>
                              ...
                              <linearGradient x1="0%" y1="0%" y2="100%" id="logo-c">
                                <stop stopColor="#78F9FF" stopOpacity=".24" offset="0%"/>
                                <stop stopColor="#43F1FF" offset="55.496%"/>
                      ...
                      <div className="hero-copy">
                        ...
                        <div className="hero-form field field-grouped is-revealing">
                          ...
                          <div className="control control-expanded">
                            <input onKeyDown={this.sendEmail.bind(this, true)} onChange={(e) => this.setState({ name: e.target.value })} className="input" type="text" name="name" placeholder="What's your name?" />
                            <input style={{ marginTop: '5px' }} onKeyDown={this.sendEmail.bind(this, true)} onChange={(e) => this.setState({ email: e.target.value })} className="input" type="email" name="email" placeholder="Your best email" />
                            <div style={{ marginTop: '5px' }} className="control">
                              <a onClick={this.sendEmail.bind(this, false)} className="button button-primary button-block">Send</a>
                            </div>
                          </div>
                        ...
                        <div className="hero-line hero-line-1">
                          <svg width="344" height="217" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path
                                ...
                                fill="url(#line-1-a)" fillRule="nonzero" transform="matrix(-1 0 0 1 343.141 0)"/>
                          </svg>
                        </div>
                      </div>
                    </div>
                        ...
                        <div className="feature">
                          <div className="feature-inner">
                            <div className="feature-header mb-16">
                                ...
                                <svg width="32" height="32" xmlns="http://www.w3.org/2000/svg">
                                  <g fillRule="nonzero" fill="none">
                                    <path
                                        ...
                                        fill="#4353FF"/>
                                    <path d="M19 20h-6a1 1 0 0 1-1-1v-6a1 1 0 0 1 1-1h6a1 1 0 0 1 1 1v6a1 1 0 0 1-1 1z"
                                          fill="#43F1FF"/>
                                    <path d="M31 8h-6a1 1 0 0 1-1-1V1a1 1 0 0 1 1-1h6a1 1 0 0 1 1 1v6a1 1 0 0 1-1 1z"
                                          fill="#4353FF"/>
                                    <path d="M7 20H1a1 1 0 0 1-1-1v-6a1 1 0 0 1 1-1h6a1 1 0 0 1 1 1v6a1 1 0 0 1-1 1z"
                                          fill="#43F1FF"/>
                                    <path d="M7 32H1a1 1 0 0 1-1-1v-6a1 1 0 0 1 1-1h6a1 1 0 0 1 1 1v6a1 1 0 0 1-1 1z"
                                          fill="#4353FF"/>
                                    <path
                              ...
                              <h4 className="feature-title m-0">Fun Quizzes</h4>
                            </div>
                            <p className="text-sm mb-0">From tough academic quizzes to super exciting fun quiz that keep you coming back for more!</p>
                          </div>
                        </div>
                        <div className="feature">
                          <div className="feature-inner">
                            <div className="feature-header mb-16">
                              ...
                              <h4 className="feature-title m-0">Create Your Own Quiz</h4>
                            </div>
                            <p className="text-sm mb-0">Do you have a great quiz idea! Or do you have an exam coming up? Create your own quiz, and share with the world!</p>
                          </div>
                        </div>
                        <div className="feature">
                          <div className="feature-inner">
                            <div className="feature-header mb-16">
                              <div className="feature-icon mr-16">
                                <svg width="32" height="32" xmlns="http://www.w3.org/2000/svg">
                                  <g fill="none" fillRule="nonzero">
                                    <path d="M16 9c2.206 0 4-1.794 4-4s-1.794-4-4-4-4 1.794-4 4 1.794 4 4 4z"
                                          fill="#4353FF"/>
                                    <path d="M27 9c2.206 0 4-1.794 4-4s-1.794-4-4-4-4 1.794-4 4 1.794 4 4 4z"
                                          fill="#43F1FF"/>
                                    <path d="M27 12c-2.206 0-4 1.794-4 4s1.794 4 4 4 4-1.794 4-4-1.794-4-4-4z"
                                          fill="#4353FF"/>
                                    <path d="M5 23c-2.206 0-4 1.794-4 4s1.794 4 4 4 4-1.794 4-4-1.794-4-4-4z"
                                          fill="#43F1FF"/>
                                    <path
                              ...
                              <h4 className="feature-title m-0">$100 Giveaway Every Month!</h4>
                            </div>
                            <p className="text-sm mb-0">Every month we give away $100 to whoever is top on the leaderboard.</p>
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              <footer className="site-footer">
                ...
                <div className="container">
                  <div className="site-footer-inner has-top-divider">
                    <div className="footer-copyright">&copy; 2018 BrainFlop, all rights reserved</div>
                    <ul className="footer-social-links list-reset">
                      ...
                      <li>
                        <a target="_blank" href="https://twitter.com/QuizOp">
